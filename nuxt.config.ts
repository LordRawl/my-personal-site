...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      htmlAttrs: { lang: 'ru' },
      title: 'Фронтенд-разработчик Иван Есин — Vue 3, Nuxt, TypeScript',
      meta: [
        { name: 'viewport', content: 'width=device-width, initial-scale=1.0' },
        {
          name: 'description',
          content:
            'Фронтенд-разработчик: 9 лет опыта, 80+ проектов на Vue 3, Nuxt и TypeScript. Высоконагруженные интерфейсы, дизайн-система, SSR. Открыт к удалённой работе.',
        },
        ...
        {
          property: 'og:title',
          content: 'Фронтенд-разработчик Иван Есин — Vue 3, Nuxt, TypeScript',
        },
        {
        ...
        { property: 'og:image:height', content: '630' },
        {
          ...
          content: 'Иван Есин — фронтенд-разработчик (Vue 3, Nuxt, TypeScript)',
        },
